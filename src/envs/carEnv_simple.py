...
class carEnv(Env):
    ...
    def reset(self):
        ...
        self.agent_state, obs_state = start_state[-1, :], start_state[:-1, :]


        # yy: force obstacles in a line
        obs_state_cp = obs_state.copy()
        num_obs = start_state[:-1, :].shape[0]
        side_lgth = self.goal_state[0]
