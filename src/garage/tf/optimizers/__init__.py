...
from garage.tf.optimizers.first_order_optimizer_comb import FirstOrderOptimizerComb
...
__all__ = [
    ...
    'FirstOrderOptimizer', 'LBFGSOptimizer', 'PenaltyLBFGSOptimizer', 'FirstOrderOptimizerComb'
]
