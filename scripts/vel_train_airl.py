...
def parse_args():
    ...
    parser.add_argument('--epoch_num', type=int, required=False, default=251)
    ...
    # parser.add_argument('--restore_pth', type=str, default="data/vel/baselines/airl")
    parser.add_argument('--restore_pth', type=str, default="data/vel/just_airl/airl")
