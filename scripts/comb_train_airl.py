...
def parse_args():
    ...
    parser.add_argument('--share_pth', type=str, default="data/comb/1_cbf_init_single/log")
    parser.add_argument('--airl_pth', type=str, default="data/comb/1_cbf_init_single/airl")
